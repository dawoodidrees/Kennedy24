      ...
      <section className="relative grid grid-cols-2 sm:grid-cols-1">
        ...
        <div className="flex items-center justify-end bg-accent-slate p-12 sm:justify-center sm:p-6">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="mx-auto max-w-[413px] text-center text-[17.6px] font-medium text-primary">As president, I will end the forever wars, clean up government, increase wealth for all, and tell Americans the truth.</p>
          </div>
        </div>
      </section>
